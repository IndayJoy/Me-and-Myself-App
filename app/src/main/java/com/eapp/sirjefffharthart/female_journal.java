...
public class female_journal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_female_journal);
        ...
        happy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mood.setText("Happy");
                Toast.makeText(female_journal.this, "Im So Happy for you!", Toast.LENGTH_SHORT).show();
            }
        });
        angry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mood.setText("Angry");
                Toast.makeText(female_journal.this, "Pls. Dont be Angry", Toast.LENGTH_SHORT).show();
            }
        });
        sad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mood.setText("Sad");
                Toast.makeText(female_journal.this, "I hope you be okay sooner or later!", Toast.LENGTH_SHORT).show();
            }
        });
        worried.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(female_journal.this, "Don't be so Worried you can do it!", Toast.LENGTH_SHORT).show();
            }
        });
        shy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mood.setText("Shy");
                Toast.makeText(female_journal.this, "You can Do it again!", Toast.LENGTH_SHORT).show();
            }
        });
        excited.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(female_journal.this, "Let's Go!", Toast.LENGTH_SHORT).show();
            }
        });
                ...
                databaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.hasChild(getUsername)){
                            ...
                            Toast.makeText(female_journal.this, "Saved", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
