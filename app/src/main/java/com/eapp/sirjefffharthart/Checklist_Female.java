...
public class Checklist_Female extends AppCompatActivity {
    ...
    String sample[] = {"Check phone for  important communications","Playing Games","Drink water","Calm Meditation Session","Fold clothes","go to gym,wash the car","go to work,Read news paper"};
    String sample2[] = {"pet care", "take out the trash", "iron the clothes", "wash the dishes", "cook dinner", "eat breakfast", "water the plants", "go for a walk", "feed your pet", "clean the house", "watch tv"};
    String sample3[] = {"1-2mins jumping jacks", "8-10 reps squat", "2 30sec per side side plank", "30-1min plank", "10 reps step-ups", "1min shoulder stand", "5reps per side plank with arm raise"};
    String sample4[] = {"do your homework,cook dinner",  "clean the house", "do the laundry", "feed the dog",  "walk the dog","go shopping","take out the trash", "go for a walk,water the plants","wash the dishes,iron the clothes,go to bed"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_checklist_female);

        Record = (TextView) findViewById(R.id.Record1);
        refresh = (ImageView) findViewById(R.id.refresh1);
        exit1 = (ImageView) findViewById(R.id.exit1);
        today = (EditText) findViewById(R.id.today1);
        act1 = (CheckBox) findViewById(R.id.act11);
        act2 = (CheckBox) findViewById(R.id.act12);
        act3 = (CheckBox) findViewById(R.id.act13);
        act4 = (CheckBox) findViewById(R.id.act14);
        ...
        Record.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Checklist_Female.this, "Recorded", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    ...
    private void setAct() {
        ...
        final View popupView = getLayoutInflater().inflate(R.layout.addactfemale, null);

        Calendar calendar = Calendar.getInstance();
        String currentDate = DateFormat.getDateInstance(DateFormat.DATE_FIELD).format(calendar.getTime());


        setdata = (Button) popupView.findViewById(R.id.setdata1);
        date = (TextView) popupView.findViewById(R.id.date1);
        Date1 = (EditText) popupView.findViewById(R.id.Date12);
        Daily1 = (EditText) popupView.findViewById(R.id.Daily11);
        Daily2 = (EditText) popupView.findViewById(R.id.Daily12);
        Daily3 = (EditText) popupView.findViewById(R.id.Daily13);
        Daily4 = (EditText) popupView.findViewById(R.id.Daily14);
        exit1 = (ImageView) popupView.findViewById(R.id.exit11);
                ...
                databaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.hasChild(getUsername)) {
                            ...
                            Toast.makeText(Checklist_Female.this, "Activity Set", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
                    }
                    @Override
